...
typedef int(*iterate_request_headers_callback)(void* data, const char* header, const char* value);

struct ngrest_mod_callbacks
{
    const char* (*iterate_request_headers)(void* req, void* data, iterate_request_headers_callback callback);
