...
#ifndef NGREST_COMMON_EXPORT_H
#define NGREST_COMMON_EXPORT_H
  ...
  #ifdef NGREST_COMMON_DLL_EXPORTS
    #define NGREST_COMMON_EXPORT NGREST_DLL_EXPORT
  #else
    #define NGREST_COMMON_EXPORT NGREST_DLL_IMPORT
  #endif
#else
  #define NGREST_COMMON_EXPORT
#endif
