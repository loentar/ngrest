...
#ifndef NGREST_ENGINE_EXPORT_H
#define NGREST_ENGINE_EXPORT_H
  ...
  #ifdef NGREST_ENGINE_DLL_EXPORTS
    #define NGREST_ENGINE_EXPORT NGREST_DLL_EXPORT
  #else
    #define NGREST_ENGINE_EXPORT NGREST_DLL_IMPORT
  #endif
#else
  #define NGREST_ENGINE_EXPORT
#endif
